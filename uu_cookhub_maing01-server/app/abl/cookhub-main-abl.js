...
const Errors = require("../api/errors/cookhub-main-error.js");
...
const logger = LoggerFactory.get("CookhubMainAbl");

class CookhubMainAbl {
  constructor() {
...
module.exports = new CookhubMainAbl();
